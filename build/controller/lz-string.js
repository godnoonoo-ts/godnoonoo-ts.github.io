export var LZString = (function () {
    ...
    var b = String.fromCharCode, c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$", e = {}, f = function () {
        return new Map();
    };
    ...
    var h = {
        ...
        compressToUint8Array: function (a) {
            for (var b = h.compress(a), c = new Uint8Array(2 * b.length), d = 0, e = b.length; e > d; d++) {
        ...
        _compress: function (a, b, c) {
            if (null == a)
                return "";
            var d, e, g, h = f(), i = f(), j = "", k = "", l = "", m = 2, n = 3, o = 2, p = [], q = 0, r = 0;
        ...
        _decompress: function (a, c, d) {
            var e, g, h, i, j, k, l, m, n = f(), o = 4, p = 4, q = 3, r = "", s = [], t = { val: d(0), position: c, index: 1 };
            for (g = 0; 3 > g; g += 1)
                n.set(g, g);
